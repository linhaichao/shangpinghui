  ...
  <div class="cart">
    ...
    <div class="cart-tool"> 
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllChecked " @click="updateAllCartChecked" :disabled="cartInfoList.length == 0">
        <span>全选</span>
      </div>
      <div class="option">
        <a href="#none" @click="deleteAllCartByChecked">删除选中的商品</a>
  ...
  export default {
    ...
    methods:{
      ...
      async updateIsChecked(cart,event){
        try {
          //event.target.checked 返回的是布尔值 要把它变成 0 或 1
